...
//    private static final int[] LONG_PRESSABLE_STATE_SET = { R.attr.state_long_pressable };   
    ...
    private CustomKeyboard mMiniKeyboard;
    ...
    public CustomKeyboard(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a =
            context.obtainStyledAttributes(
                attrs, R.styleable.CustomKeyboard, defStyle, 0);
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
//            case R.styleable.CustomKeyboard_keyBackground:
//                mKeyBackground = a.getDrawable(attr);
//                break;
//            case R.styleable.CustomKeyboard_verticalCorrection:
//                mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
//                break;
//            case R.styleable.CustomKeyboard_keyPreviewLayout:
//                previewLayout = a.getResourceId(attr, 0);
//                break;
//            case R.styleable.CustomKeyboard_keyPreviewOffset:
//                mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
//                break;
//            case R.styleable.CustomKeyboard_keyPreviewHeight:
//                mPreviewHeight = a.getDimensionPixelSize(attr, 80);
//                break;
            case R.styleable.CustomKeyboard_android_keyTextSize:
                mKeyTextSize = a.getDimensionPixelSize(attr, 18);
                break;
            case R.styleable.CustomKeyboard_android_keyTextColor:
                mKeyTextColor = a.getColor(attr, 0xFF000000);
                break;
            case R.styleable.CustomKeyboard_android_labelTextSize:
                mLabelTextSize = a.getDimensionPixelSize(attr, 14);
                break;
//            case R.styleable.CustomKeyboard_popupLayout:
//                mPopupLayout = a.getResourceId(attr, 0);
//                break;
            case R.styleable.CustomKeyboard_android_shadowColor:
                mShadowColor = a.getColor(attr, 0);
                break;
            case R.styleable.CustomKeyboard_android_shadowRadius:
...
//                android.R.bool.config_swipeDisambiguation);
    ...
    protected boolean onLongPress(Key popupKey) {
        ...
        if (popupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                mMiniKeyboard = (CustomKeyboard) mMiniKeyboardContainer.findViewById(
